...
devices = [
    {'device_type': 'cisco_ios', 'host': ip, 'username': 'admin', 'password': 'admin', 'name': name}
...
def backup_config(device):
    try:
        ...
        with ConnectHandler(**device) as conn:
            ...
            # Crear carpeta por nombre del router
            ...
            with open(backup_time_file, 'w') as f:
                ...
                f.write(f"Configuración del router {device['name']} guardada correctamente.\n")
            
            print(f"Backup de {device['name']} realizado correctamente.")
            return backup_file
...
def main():
    for device in devices:
        ...
        if backup_file:
            ...
            print(f"No se pudo realizar el backup para {device['name']}.")
